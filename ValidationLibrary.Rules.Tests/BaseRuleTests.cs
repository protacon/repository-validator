...
namespace ValidationLibrary.Tests.Rules
{
    ...
    public abstract class BaseRuleTests<T> where T : IValidationRule
    {
        ...
        {
            return new Repository(null, null, null, null, null, null, null, 0, null, Owner, name, null, false, null, null, null, false, false, 0, 0, null, 0, null, DateTime.UtcNow, DateTime.UtcNow, null, null, null, null, false, false, false, false, 0, 0, null, null, null, false, 0, false, RepositoryVisibility.Public);
        }
    }
}
